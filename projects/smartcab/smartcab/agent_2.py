...
class LearningAgent(Agent):
    ...
    def update(self, t):
        ...
        if self.planner.next_waypoint() == None:
            print "Reached destination in {} timesteps. Net reward: {}, Penalties: {}".format(t + 1, self.net_reward,
                                                                                              self.penalties)
        elif deadline == 0:
            print "Failed to reach desination in {} timesteps. Net reward: {}, Penalties: {}".format(t + 1,
                                                                                                     self.net_reward,
                                                                                                     self.penalties)
